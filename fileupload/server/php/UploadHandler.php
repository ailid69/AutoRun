...
class UploadHandler
{
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
		...
		//Check if file name is already known
    ...
    public function generate_response($content, $print_response = true) {
		...
		//error_log("json : " .$json);
	//	error_log("-- END UploadHandler generate_response ---");
        return $content;
    }
    ...
    public function get($print_response = true) {
        ...
        error_log("-- UploadHandler GET ---");
		$file_name = $this->get_file_name_param();
		error_log("filename (from this->get_file_name_param) : " . $file_name);
        if ($file_name) {
			//error_log("YES we have a file_name");
            $response = array(
			...
			$response = array(
                $this->options['param_name'] => $this->get_file_objects_fromDB()
            );
        }
    ...
    public function post($print_response = true) {
        //error_log('--- Entering function POST from parent');
    ...
    public function delete($print_response = true) {
		//error_log("start parent delete funtion");
		...
		//error_log("end parent delete funtion");
        return $this->generate_response($response, $print_response);
    }
